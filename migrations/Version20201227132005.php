...
final class Version20201227132005 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article_entity (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, url_alias VARCHAR(255) NOT NULL, intro VARCHAR(255) NOT NULL, content VARCHAR(300) NOT NULL, published DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
